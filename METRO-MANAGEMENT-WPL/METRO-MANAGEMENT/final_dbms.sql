...
<head>
  ...
  <script type="text/javascript" src="http://ff.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=3qdR2-i7KMrj0bc-i_Qqc9LShds98WegQkSfecbV3BakVwkJn5ghG13dFu-piP4pR_iQCfXjruRF5vWJeR2rQFpeEsUZW4b6NPVXKxaN6NI" charset="UTF-8"></script><style id="cfs-style">html{display: none;}</style>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1387927192ltr&server=1">
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="513c7e747544252f4f26782c65464b29">
