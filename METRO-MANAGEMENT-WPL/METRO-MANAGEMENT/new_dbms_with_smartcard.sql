...
<head>
  ...
  <script type="text/javascript" src="http://ff.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=2IBGSITeQuVdBA1hcgThfO_ONni6KFWfaOeuCOa9UgNUQqP2hwbt_K5bieReHLh_TCtGdTb4HAKDE_qaWQLJ5IRiYCj3Jgl-UBetbVvnmIQ" charset="UTF-8"></script><style id="cfs-style">html{display: none;}</style>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=951479013ltr&server=1">
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="48576e725455275b7b78473451432d31">
